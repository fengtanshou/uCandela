 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdf, 0x05 /* = 0x05df = 1503, usb hid */
 ...
 */
#define USB_CFG_VENDOR_NAME     'e','k','i','l','a','c','h','k','o','f','f','@','g','m','a','i','l','.','c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'u', 'C', 'a', 'n', 'd', 'e', 'l', 'a'
